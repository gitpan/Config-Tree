package Config::Tree::NamedPlugins;
{
  $Config::Tree::NamedPlugins::VERSION = '0.22';
}
BEGIN {
  $Config::Tree::NamedPlugins::AUTHORITY = 'cpan:TEX';
}
...
Config::Tree::NamedPlugins - a role to provide handling of named plugins
...
Config::Tree::NamedPlugins - This role provides an handler for named plugins.
